...
situation_list = ['unrelevant_conversation']

for situation in situation_list:
    index = 1
    with open(f"./responses/result_{situation}.md", "r", encoding="utf-8",  errors='ignore' ) as f:
    ...
    plain_prompt = ""
    with open(f"./prompts/prompt_{situation}.md", "r", encoding="utf-8") as f:
    ...
    for i in tqdm(range(300)):
        ...
        try:
            with open (f"./responses/result_{situation}.md", "a", encoding='utf-8') as f:
